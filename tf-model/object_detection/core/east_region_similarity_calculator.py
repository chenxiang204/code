...
from object_detection.core import east_box_list_ops
...
class EastIouSimilarity(RegionSimilarityCalculator):
  ...
  def _compare(self, boxlist1, boxlist2):
    ...
    """
    return east_box_list_ops.east_iou(boxlist1, boxlist2)
