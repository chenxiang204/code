...
def _build_east_model(ssd_config, is_training):
  ...
  matcher = matcher_builder.build(east_config.matcher)
  region_similarity_calculator = sim_calc.build(
      east_config.similarity_calculator)
  east_box_predictor = box_predictor_builder.build(hyperparams_builder.build,
